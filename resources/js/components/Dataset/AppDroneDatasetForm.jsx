...
import { Database, Save, X, ArrowLeft, Target, Navigation, Zap, Compass, Activity, ShieldAlert } from 'lucide-react';
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <nav className="hidden sm:flex" aria-label="Breadcrumb">
                            <ol className="flex items-center space-x-2 text-sm font-medium text-slate-500">
                                ...
                                <li><a href={routes.index} className="hover:text-sky-600 transition-colors">Dataset Drone</a></li>
                                <li><span className="mx-2 text-slate-300">/</span></li>
