        ...
        <a href="{{ route('dashboard') }}" id="app-logo"
           class="flex items-center gap-3 shrink-0 group">
            <img src="{{ asset('images/logo-ipb.png') }}"
                 ...
                 style="filter: brightness(0) saturate(100%) invert(14%) sepia(77%) saturate(1500%) hue-rotate(210deg) brightness(90%) contrast(105%);"
                 onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
            <div style="display:none"
                 class="w-10 h-10 rounded-full items-center justify-center font-black text-lg"
                 style="background:#1e3a8a; color:white">GCS</div>
