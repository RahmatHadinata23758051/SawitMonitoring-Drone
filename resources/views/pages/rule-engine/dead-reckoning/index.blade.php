    ...
    <x-slot name="header">
        <h2 class="leading-tight">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item breadcrumb-active">{{ __('Dead-Reckoning') }}</li>
            </ol>
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 flex flex-col gap-4">
            ...
            <div class="bg-white overflow-hidden shadow-sm">
                <div class="overflow-x-scroll">
                    <table class="w-full align-middle border-slate-400 table mb-0 px-2" id="dead-reckoning-table">
                        <thead>
                            <tr>
                                <th class="dt-center">No</th>
                                <th class="dt-center">Aksi Drone</th>
                                <th class="dt-center">Durasi</th>
                                <th class="dt-center">Satuan Waktu</th>
                                ...
                                <tr>
                                    ...
                                    <td class="h-full">
                                        <div class="flex items-center justify-center gap-2 h-full">
                                            <a href="{{ route('dead-reckoning.edit', $rule->id) }}" class="h-100">
                                                <i class="fa fa-pen text-yellow-500"></i>
                                            </a>
                                            <form action="{{ route('dead-reckoning.destroy', $rule->id) }}" method="POST"
                                                class="delete-form" data-id="{{ $rule->id }}">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit">
        ...
        <script>
            ...
            window.addEventListener('load', function() {
                ...
                $(document).ready(function() {
                    table = $('#dead-reckoning-table').DataTable({
                        responsive: true,
                        ordering: false,
                        ...
                        buttons: [{
                            extend: 'excel',
                            text: 'Export Excel',
                            title: 'Rule Engine Dead-Reckoning',
                        ...
                        language: {
                            emptyTable: "Tidak ada rule yang tersedia",
                            paginate: {
                                previous: "<",
                                next: ">"
                            },
                            zeroRecords: "Rule tidak ditemukan.",
                ...
                document.querySelectorAll('.delete-form').forEach(form => {
                    form.addEventListener('submit', function(event) {
                        ...
                        Swal.fire({
                            title: 'Konfirmasi',
                            text: `Apakah Anda yakin ingin menghapus rule dengan ID ${ruleId}?`,
                            icon: 'warning',
