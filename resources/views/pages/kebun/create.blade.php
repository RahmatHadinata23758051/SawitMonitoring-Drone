                ...
                <div class="grid grid-cols-1 xl:grid-cols-[minmax(0,1.65fr)_420px] gap-6 items-start">
                        ...
                        <div class="px-6 py-5 border-b border-slate-200 bg-slate-50/80">
                            <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                                <div>
                                    ...
                                    <p class="text-sm text-slate-500 mt-1">Gambar polygon kebun pada peta. Sistem akan
                    ...
                    <aside class="bg-white shadow-sm rounded-2xl border border-slate-200 overflow-hidden xl:sticky xl:top-6">
                        <div class="px-6 py-5 border-b border-slate-200">
                            ...
                            <p class="text-sm text-slate-500 mt-1">Isi detail kebun di panel kanan. Nilai luas dan titik
                                lokasi diisi otomatis dari polygon.</p>
                        </div>
        ...
        <script>
            ...
            legend.onAdd = function() {
                ...
                div.innerHTML = `
                    ...
                    <div class="text-[11px] text-slate-500">Gambar polygon kebun menggunakan toolbar peta.</div>
                `;
                return div;
            };
