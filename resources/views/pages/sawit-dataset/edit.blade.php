        ...
        <div class="max-w-8xl mx-auto px-3 sm:px-6 lg:px-8 flex flex-col gap-4">
            <div class="flex justify-center items-center w-full">
                <div class="bg-white shadow-sm w-full md:w-5/6 lg:w-3/4 h-auto px-6 py-4 rounded-lg">
                    <div class="mb-5">
                        <h3 class="text-lg font-semibold">Edit Dataset Sawit</h3>
                        <p class="text-sm text-slate-500">Silakan isi semua informasi yang dibutuhkan</p>
                    </div>
                    <form action="{{ route('sawit-dataset.update', $sawitDataset->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <x-text-input id="kode" class="block mt-1 w-full rounded-xl bg-gray-100"
                                    type="text" name="kode" :value="old('kode', $sawitDataset->kode)" required autofocus
                                    autocomplete="kode" />
                            ...
                            <div>
                                ...
                                <x-text-input id="nama" class="block mt-1 w-full rounded-xl bg-gray-100"
                                    type="text" name="nama" :value="old('nama', $sawitDataset->nama_class)" required autofocus
                                    autocomplete="nama" />
                            ...
                            <div>
                                ...
                                <x-text-input id="warna" class="block mt-1 w-full rounded-xl bg-gray-100"
                                    type="text" name="warna" :value="old('warna', $sawitDataset->warna_buah)" required autofocus
                                    autocomplete="warna" />
